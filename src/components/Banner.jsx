        ...
        <div className="flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <p className="mt-8 text-slate-600 text-lg md:text-xl max-w-2xl leading-relaxed mx-auto lg:mx-0">
              ...
              waiting for a family to call their own. Your journey starts with a wag.
            </p>
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              >
                Find a Pet <FiArrowRight className="group-hover:translate-x-1 transition-transform" />
              </Link>
          ...
          <div className="flex-1 relative group">
            ...
            <div className="absolute -bottom-6 -left-6 bg-white p-4 rounded-2xl shadow-xl z-20 hidden md:flex items-center gap-4 animate-bounce-slow">
              ...
              <div>
                <p className="text-sm font-bold text-slate-800 tracking-tight">Meet "Buddy"</p>
                <p className="text-xs text-slate-500 font-medium">Ready for adoption</p>
              </div>
            </div>
          </div>
